...
import { editSuccess, loginSuccess } from "../redux/user/userSlice";
import { editUser } from "../redux/user/userApiRequest";
...
const EditProfile = () => {
  ...
  const handleEditProfile = (e) => {
    ...
    editUser(dispatch, editedUser, navigate, accessToken, axiosJWT);
  };
  return (
    <div>
      <div>
