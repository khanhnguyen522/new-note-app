          ...
          <div className="m-6">
            ...
            >
              ...
              <div className="flex justify-center">
                <div className="rounded-md bg-[rgb(134,122,245)] text-white text-sm mx-4 p-2 px-14">
            ...
            <div className=" flex justify-center items-center   ">
              <button
                className=" bg-[#e07272]/90 w-[30%] rounded-md text-white text-sm  p-2 text-center my-4"
